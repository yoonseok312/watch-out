...
//
//  Created by doyeon on 2020/08/19.
//  Copyright © 2020 yoonseok. All rights reserved.
//

import SwiftUI

struct InOperation: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                NavigationLink(destination: AlertView(type: "car")) {
                    Text(/*@START_MENU_TOKEN@*/"자동차"/*@END_MENU_TOKEN@*/)
                }
                
                NavigationLink(destination: AlertView(type: "fire")) {
...
struct InOperation_Previews: PreviewProvider {
